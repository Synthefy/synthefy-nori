...
from synthefy_nori.utils.data_utils import NoriInferenceDataset, cluster_test_data, fix_data_shape
from synthefy_nori.utils.inference_utils import NonPaddingDistributedSampler, swap_rows_back
from synthefy_nori.utils.loading import load_model

from synthefy_nori.utils.retrieval_utils import RelabelRetrievalY, find_top_K_indice
...
class InferenceResultWithRetrieval:
    ...
    def _prepare_data(self,
                      ...
                      ) -> NoriInferenceDataset:
        if self.sample_selection_type == "AM":
            use_retrieval = True
        else:
            use_retrieval = False
        dataset = NoriInferenceDataset(
            X_train=X_train,
            y_train=y_train,
            X_test=X_test,
    ...
    def inference(self,
                  ...
                  dataset: NoriInferenceDataset = None,
