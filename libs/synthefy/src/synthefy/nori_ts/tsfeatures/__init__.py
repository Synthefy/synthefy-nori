...
Re-checking the pin: normalize the import paths and diff against upstream, e.g.
    ...
    sed 's#synthefy.nori_ts.tsfeatures#tabpfn_time_series.features#g' \\
...
from synthefy.nori_ts.tsfeatures.data_preparation import generate_test_X
from synthefy.nori_ts.tsfeatures.feature_generator_base import FeatureGenerator
from synthefy.nori_ts.tsfeatures.feature_transformer import FeatureTransformer
from synthefy.nori_ts.tsfeatures.basic_features import (
    RunningIndexFeature,
    CalendarFeature,
    AdditionalCalendarFeature,
)
from synthefy.nori_ts.tsfeatures.auto_features import AutoSeasonalFeature
