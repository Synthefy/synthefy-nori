"""Zero-shot text features for Synthefy Nori.
    ...
    if isinstance(embedder, str):
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install it with `pip install synthefy[text]` (or "
                "`pip install synthefy-nori[text]` for the local Nori package), "
                "or pass a preloaded encoder "
